<?php
/**
 * dickensleungwebportfolio functions and definitions
 *
 ...
 */
function dickensleungwebportfolio_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on dickensleungwebportfolio, use a find and replace
		* to change 'dickensleungwebportfolio' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'dickensleungwebportfolio', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'dickensleungwebportfolio' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'dickensleungwebportfolio_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'dickensleungwebportfolio_setup' );
 ...
 */
function dickensleungwebportfolio_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dickensleungwebportfolio_content_width', 640 );
}
add_action( 'after_setup_theme', 'dickensleungwebportfolio_content_width', 0 );
 ...
 */
function dickensleungwebportfolio_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dickensleungwebportfolio' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dickensleungwebportfolio' ),
...
add_action( 'widgets_init', 'dickensleungwebportfolio_widgets_init' );
...
/**
 * Implement custom taxonomy NON HIERARCHICAL (LIKE TAG).
 */

function dl_register_taxonomies() {
	// Add Skills taxonomy
